...
;(function(win,$,e){
    ...
    function Main(options){
        if(!(this instanceof Main)){return new Main(options)}
        var s = this;
        var defaultOpt = {
            "page" : 0,                                         //页数
        ...
        $(".of-tab ul li").click(function () {
            ...
            switch (_index) {
                ...
                case 1:
                    ...
                    conInner.animate({"top": -bh}, 400, "linear");
                    s.opt.page = 1;
                    break;
                case 2:
                    ss.css("borderBottom", "4px solid #3a6e90");
                    conInner.animate({"top": -2 * bh}, 400, "linear");
                    s.opt.page = 2;
                    break;
                case 3:
                    ss.css("borderBottom", "4px solid #3a9b7a");
                    conInner.animate({"top": -3 * bh}, 400, "linear");
                    s.opt.page = 3;
                    break;
            }
    ...
    function pageTwoExc(s){
        ...
        $(".mod-sm-lf").click(function () {
            ...
            $(".right-pic").stop().animate({
                ...
                $(".right-pic").append(picLi.eq(0).clone()[0]).css("left", -pLW);
                picLi.eq(0).remove();
                rp++;
                if (rp == 4) {
                    rp = 0;
                }
                $(".leftWord li").eq(rp).css("display","block").fadeIn().siblings().fadeOut();
                $(".mod-2-right ol li").eq(rp).addClass("dotActive").siblings().removeClass("dotActive");
